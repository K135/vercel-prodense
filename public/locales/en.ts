export const en = {
  ...
  HeroSearchForm: {
    ...
    'Where are you going?': 'Which destination for treatment?',
    'Add dates': 'Add treatment dates',
    Date: 'Date',
    'Date range': 'Date range',
    search: 'Find Treatment',
    ...
    'Start your search': 'Start your search',
    'Anywhere • Any week • Add guests': 'Any destination • Any procedure • Any time',
    'Clear all': 'Clear all',
    Where: 'Where',
    When: 'When',
    "When's your trip?": "When's your trip?",
    Destinations: 'Destinations',
    'Search destinations': 'Search medical destinations',
    'Popular destinations': 'Popular medical destinations',
    Who: 'Who',
