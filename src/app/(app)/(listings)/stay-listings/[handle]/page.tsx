      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-[#D35C2F] mx-auto mt-6 rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#D35C2F] to-[#0366d6]"></div>
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-[#D35C2F]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#D35C2F]/20 transition-colors duration-300">
                    <HugeiconsIcon icon={HospitalIcon} size={28} className="text-[#D35C2F]" />
                  </div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center gap-3 text-sm text-neutral-700 dark:text-neutral-300">
                    <div className="w-2 h-2 bg-[#D35C2F] rounded-full flex-shrink-0"></div>
            ...
            <div className="group relative bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-[#D35C2F]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#D35C2F]/20 transition-colors duration-300">
                    <HugeiconsIcon icon={StarIcon} size={28} className="text-[#D35C2F]" />
                  </div>
            ...
            <div className="group relative bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-[#D35C2F]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#D35C2F]/20 transition-colors duration-300">
                    <HugeiconsIcon icon={StethoscopeIcon} size={28} className="text-[#D35C2F]" />
                  </div>
            ...
            <div className="group relative bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-[#D35C2F]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#D35C2F]/20 transition-colors duration-300">
                    <HugeiconsIcon icon={FavouriteIcon} size={28} className="text-[#D35C2F]" />
                  </div>
            ...
            <div className="group relative bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-[#D35C2F]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#D35C2F]/20 transition-colors duration-300">
                    <HugeiconsIcon icon={MedicalMaskIcon} size={28} className="text-[#D35C2F]" />
                  </div>
            ...
            <div className="group relative bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-[#D35C2F]/10 rounded-2xl flex items-center justify-center group-hover:bg-[#D35C2F]/20 transition-colors duration-300">
                    <HugeiconsIcon icon={ShieldIcon} size={28} className="text-[#D35C2F]" />
                  </div>
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-[#D35C2F]/5 to-[#0366d6]/5 rounded-3xl p-8 border border-[#D35C2F]/20">
              ...
              <div className="flex justify-center">
                <button className="bg-[#D35C2F] hover:bg-[#0369d1] text-white font-bold py-4 px-8 rounded-2xl shadow-lg hover:shadow-2xl transform hover:scale-[1.02] transition-all duration-300 text-base border border-[#D35C2F]">
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="text-center">
          ...
          <div className="w-24 h-1 bg-[#D35C2F] mx-auto rounded-full"></div>
        </div>
          ...
          {dentists.map((dentist, index) => (
            <div key={index} className="group bg-white dark:bg-neutral-800 rounded-3xl border border-neutral-200 dark:border-neutral-700 shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <p className="text-[#D35C2F] font-semibold mb-3">
                  {dentist.specialty}
                </p>
                
                <div className="flex items-center gap-2 mb-4">
                  <HugeiconsIcon icon={Award01Icon} size={18} className="text-[#D35C2F]" />
                ...
                <div className="flex items-center gap-2">
                  <HugeiconsIcon icon={CertificateIcon} size={18} className="text-[#D35C2F]" />
                  <span className="text-neutral-600 dark:text-neutral-400 text-sm">
                    DDS Certified
                  </span>
                </div>
