    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 max-w-2xl mx-auto">
          Seamless post-treatment support, find local dentists for follow-up care, access treatment records, and maintain your dental health journey.
        </p>
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 max-w-md mx-auto border border-slate-200 dark:border-slate-700">
          <p className="text-slate-500 dark:text-slate-400">
            💝 Comprehensive continuity care platform coming soon!
          </p>
        </div>
      </motion.div>
    </div>
