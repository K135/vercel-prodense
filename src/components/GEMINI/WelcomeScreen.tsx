    ...
    <div className="flex flex-col items-center justify-center h-full text-center px-6">
      ...
      >
        ...
        <p className={clsx(
          ...
          Start a conversation with Prodense advanced AI model. Ask questions, get creative help, 
      ...
      >
        <p className={clsx(
          ...
          Powered by Prodense Prodense • AI responses may contain inaccuracies
        </p>
      </motion.div>
    </div>
  )
