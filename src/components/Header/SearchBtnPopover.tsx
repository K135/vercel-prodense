          ...
          <div className="mx-auto flex w-full max-w-xl flex-col py-4">
            ...
            >
              ...
              <input
                ...
                name="q"
                placeholder="Search dental procedures, destinations..."
                aria-label="Search for dental procedures and destinations"
                autoComplete="off"
                autoCorrect="off"
                autoCapitalize="off"
                spellCheck="false"
            ...
            <div className="block text-xs/6 text-neutral-500 md:hidden">
              Search for dental procedures, medical destinations, and healthcare services.{' '}
