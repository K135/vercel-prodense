        ...
        {value
          ? // if input value is not empty, show suggestions based on input
            renderSearchValues({
              ...
              items: ['Goa', 'Kerala', 'Mumbai', 'Delhi', 'Chennai'],
            })
          : // if input value is empty, show popular medical destinations suggestions
            renderSearchValues({
              heading: T['HeroSearchForm']['Popular destinations'],
              items: ['Goa', 'Kerala', 'Rajasthan', 'Tamil Nadu', 'Karnataka'],
            })}
      </div>
    </div>
  )
