...
const SectionGetToKnowAboutUs: FC<Props> = ({ className = '' }) => {
  return (
    <section className={`relative py-4 lg:py-8 bg-gradient-to-br from-neutral-50 via-white to-[#e6ba47]/10 dark:from-neutral-900 dark:via-neutral-900 dark:to-[#e6ba47]/5 overflow-hidden ${className}`}>
          ...
          <div className="relative space-y-8">
            ...
            <div className="space-y-6">
              <div className="inline-flex items-center">
                <span className="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-[#e6ba47]/10 to-[#e6ba47]/20 dark:from-[#e6ba47]/30 dark:to-[#e6ba47]/20 text-[#e6ba47] dark:text-[#e6ba47] text-sm font-semibold rounded-full border border-[#e6ba47]/20 dark:border-[#e6ba47]/50 shadow-sm">
              ...
              >
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#e6ba47] to-[#e6ba47]/80 dark:from-[#e6ba47] dark:to-[#e6ba47]/80">
                  Without Borders
                </span>
              </Heading>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Feature 1 */}
              <div className="group relative bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm rounded-2xl p-6 hover:shadow-xl hover:shadow-[#e6ba47]/10 transition-all duration-500 border border-neutral-200/50 dark:border-neutral-700/50 hover:border-[#e6ba47]/30 dark:hover:border-[#e6ba47]/50 hover:-translate-y-1">
                <div className="absolute inset-0 bg-gradient-to-br from-[#e6ba47]/5 to-[#e6ba47]/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                <div className="relative">
                  <div className="flex items-center mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-[#e6ba47] to-[#e6ba47]/80 rounded-xl flex items-center justify-center mr-4">
            ...
            {/* Mission & Vision */}
            <div className="bg-gradient-to-r from-[#e6ba47]/5 to-[#e6ba47]/10 dark:from-[#e6ba47]/10 dark:to-[#e6ba47]/20 rounded-3xl p-8 border border-[#e6ba47]/20 dark:border-[#e6ba47]/30">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <div className="flex items-center mb-4">
                    <div className="w-10 h-10 bg-gradient-to-br from-[#e6ba47] to-[#e6ba47]/80 rounded-lg flex items-center justify-center mr-3">
