            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {message.options.map((option) => (
                <motion.button
                  ...
                  className={clsx(
                    'flex items-center justify-center space-x-2 px-4 py-3 rounded-xl border-2 transition-all duration-200 text-sm font-medium',
                    isDarkMode
                      ? 'border-gray-600 bg-gray-700 hover:bg-gray-600 hover:border-[#D35C2F] text-gray-100'
                      : 'border-gray-200 bg-gray-50 hover:bg-white hover:border-[#D35C2F] text-gray-700'
                  )}
                >
                  {option.emoji && (
