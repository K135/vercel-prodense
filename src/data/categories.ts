  ...
  return [
    {
      ...
      region: 'India',
      handle: 'goa-india',
      href: '/stay-categories/goa-india',
      count: 5000,
      thumbnail:
      ...
      description: 'Beautiful beaches and vibrant nightlife in India\'s coastal paradise',
    },
    {
      id: 'stay-cat://2',
      name: 'Kerala, India',
      region: 'India',
      handle: 'kerala-india',
      href: '/stay-categories/kerala-india',
      count: 2500,
      thumbnail: 'https://images.pexels.com/photos/962464/pexels-photo-962464.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
    ...
    },
    {
      ...
      region: 'India',
      handle: 'rajasthan-india',
      href: '/stay-categories/rajasthan-india',
      count: 3000,
    ...
    },
    {
      ...
      region: 'India',
      handle: 'himachal-pradesh-india',
      href: '/stay-categories/himachal-pradesh-india',
      count: 116288,
      thumbnail: 'https://images.pexels.com/photos/1365425/pexels-photo-1365425.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
        width: stayCategoryCoverImage.width,
        height: stayCategoryCoverImage.height,
      },
      description: 'Mountain paradise with snow-capped peaks, hill stations and adventure sports',
    },
    {
      id: 'stay-cat://5',
      name: 'Uttarakhand, India',
      region: 'India',
      handle: 'uttarakhand-india',
      href: '/stay-categories/uttarakhand-india',
      count: 5000,
      thumbnail: 'https://images.pexels.com/photos/1365425/pexels-photo-1365425.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
      ...
      description: 'Devbhoomi with sacred temples, yoga retreats and Himalayan adventures',
    },
    {
      id: 'stay-cat://6',
      name: 'Tamil Nadu, India',
      region: 'India',
      handle: 'tamil-nadu-india',
      href: '/stay-categories/tamil-nadu-india',
      count: 7500,
      thumbnail: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
      ...
      description: 'Rich cultural heritage with ancient temples, classical arts and coastal beauty',
    },
    {
      id: 'stay-cat://7',
      name: 'Karnataka, India',
      region: 'India',
      handle: 'karnataka-india',
      href: '/stay-categories/karnataka-india',
      count: 8100,
      thumbnail: 'https://images.pexels.com/photos/3581368/pexels-photo-3581368.jpeg',
      coverImage: {
        src: stayCategoryCoverImage.src,
      ...
      description: 'Silicon Valley of India with historic palaces, coffee plantations and tech hubs',
    },
    {
      id: 'stay-cat://8',
