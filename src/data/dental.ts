  ...
  return [
    {
      ...
      address: 'Teşvikiye, Hakkı Yeten Cd. No:11, 34365 Şişli/İstanbul, Türkiye',
      phone: '(555) 123-4567',
    ...
    },
    {
      ...
      address: '321 Elm Drive, New York, NY 10004',
      phone: '(555) 456-7890',
...
export async function getDentalFilterOptions() {
  return [
    ...
    },
    {
      ...
      tabUIType: 'checkbox' as const,
      options: [
        { name: 'New York, NY', value: 'new_york', defaultChecked: false },
        { name: 'Los Angeles, CA', value: 'los_angeles', defaultChecked: false },
        { name: 'Chicago, IL', value: 'chicago', defaultChecked: false },
        { name: 'Houston, TX', value: 'houston', defaultChecked: false },
        { name: 'Miami, FL', value: 'miami', defaultChecked: false },
        { name: 'San Francisco, CA', value: 'san_francisco', defaultChecked: false },
        { name: 'Boston, MA', value: 'boston', defaultChecked: false },
        { name: 'Seattle, WA', value: 'seattle', defaultChecked: false },
      ],
    },
  ]
}