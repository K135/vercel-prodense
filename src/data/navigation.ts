  ...
  return [
    {
      ...
      type: 'dropdown',
      children: [
        { id: '1-1', href: '/procedures/dental-implants', name: 'Dental Implants' },
        { id: '1-2', href: '/procedures/teeth-whitening', name: 'Teeth Whitening' },
        { id: '1-3', href: '/procedures/root-canal', name: 'Root Canal Treatment' },
        { id: '1-4', href: '/procedures/orthodontics', name: 'Orthodontics' },
        { id: '1-5', href: '/procedures/oral-surgery', name: 'Oral Surgery' },
        { id: '1-6', href: '/procedures/cosmetic-dentistry', name: 'Cosmetic Dentistry' },
      ],
    },
    {
      id: '2',
      ...
      type: 'dropdown',
      children: [
        { id: '2-1', href: '/destinations/goa', name: 'Goa' },
        { id: '2-2', href: '/destinations/kerala', name: 'Kerala' },
        { id: '2-3', href: '/destinations/rajasthan', name: 'Rajasthan' },
        { id: '2-4', href: '/destinations/tamil-nadu', name: 'Tamil Nadu' },
        { id: '2-5', href: '/destinations/karnataka', name: 'Karnataka' },
        { id: '2-6', href: '/destinations/himachal-pradesh', name: 'Himachal Pradesh' },
      ],
    },
    {
      id: '3',
    ...
    },
    {
      ...
      type: 'dropdown',
      children: [
        { id: '4-1', href: '/about', name: 'About Us' },
        { id: '4-2', href: '/brand-story', name: 'Brand Story' },
        { id: '4-3', href: '/prodense-promise', name: 'Prodense Promise' },
        { id: '4-4', href: '/csr', name: 'CSR' },
      ],
    },
    {
      id: '5',
...
export async function getNavMegaMenu(): Promise<TNavigationItem> {
  ...
  // Since we don't have mega-menu type in medical tourism, return the first dropdown item
  return navigation.find((item) => item.type === 'dropdown' && item.name === 'Procedures') || {}
}
